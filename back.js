window.addEventListener("load", () => {
  ...
  // This is not related to the background. This is so Kynan can tell how often people look at his site.
  const add = () => {
    fetch("https://api.jsonbin.io/b/60afee5aa5cd4a5576a8d3f1/latest", {
      "headers": {
        "accept": "*/*",
        ...
        "secret-key": "$2b$10$veVVf2YF3g2KMM9cTA2KueBZjncRt7/j9TYAbl7SfqzNfKzTwCRku"
      },
      ...
      console.log(d);
      fetch("https://api.jsonbin.io/v3/b/60afee5aa5cd4a5576a8d3f1", {
        "headers": {
          "accept": "*/*",
          "accept-language": "en-US,en;q=0.9",
          ...
          "sec-fetch-mode": "cors",
          "sec-fetch-site": "cross-site",
          "x-master-key": "$2b$10$eo9pD4IT2rUvYX.xWq6udeqL1TOYHqs5C3kHKFTx.U2DzzOwkjgLy"
        },
        "referrerPolicy": "strict-origin-when-cross-origin",
        "body": "{\"views\": " + ((d.views || 0) + 1) + "}",
        "method": "PUT",
        "mode": "cors",
        "credentials": "omit"
